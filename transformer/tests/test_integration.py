    ...
    def test_config_validation(self):
        ...
        configs = [
            ...
            TransformerModelConfig(
                name="small", input_dim=4, embed_dim=16, 
                ffn_latent_dim=64, num_layers=1, num_heads=2, output_dim=1
            ),
            # Medium model
            TransformerModelConfig(
                name="medium", input_dim=8, embed_dim=32, 
                ffn_latent_dim=128, num_layers=2, num_heads=4, output_dim=1
            ),
            # Large model
            TransformerModelConfig(
                name="large", input_dim=16, embed_dim=64, 
                ffn_latent_dim=256, num_layers=3, num_heads=8, output_dim=1
            ),
        ]
