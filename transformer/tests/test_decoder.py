...
class TestDecoder:
    ...
    def test_init_valid_params(self):
        ...
        assert decoder.self_attention.apply_causal_mask == True
        
        assert decoder.cross_attention.embed_dim == embed_dim
        assert decoder.cross_attention.num_heads == num_heads
        assert decoder.cross_attention.apply_causal_mask == False
    ...
    def test_masked_self_attention(self):
        ...
        for i in range(tgt_len):
            decoder_input[0, i, :] = i + 1  # Position 0: all 1s, position 1: all 2s, etc.
    ...
    def test_parameter_count(self):
        ...
        expected_min = 8 * embed_dim * embed_dim + 2 * embed_dim * latent_dim + 3 * embed_dim
